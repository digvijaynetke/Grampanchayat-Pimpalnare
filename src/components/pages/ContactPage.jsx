                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+918XXXXXXXX4" className="text-gray-600 hover:text-teal-600 transition">
                        +91 8XXXXXXXX4
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:chपिंपळणारे@gmail.com" className="text-gray-600 hover:text-teal-600 transition">
                        chपिंपळणारे@gmail.com
                      </a>
                    </div>
                  </div>
